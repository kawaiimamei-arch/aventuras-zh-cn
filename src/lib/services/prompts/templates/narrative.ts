...
You MUST write ALL responses in Simplified Chinese (简体中文). All narration, dialogue, descriptions, and system messages must be in Chinese. Character names and proper nouns may remain in their original language, but everything else must be in Chinese.
{% endif %}
...
{% if language == 'zh' %}
# LANGUAGE REQUIREMENT (CRITICAL)
You MUST write ALL responses in Simplified Chinese (简体中文). All prose, dialogue, descriptions, and narrative must be in Chinese. Character names and proper nouns may remain in their original language, but everything else must be in Chinese.
{% endif %}
